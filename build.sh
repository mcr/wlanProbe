...
mkdir -p $BUILD
#make -C $MICROPYTHON/ports/$TARGET FROZEN_MPY_DIR=${HERE}/py FLASH_MODE=dio $*
make -C $MICROPYTHON/ports/$TARGET BUILD=$BUILD FROZEN_MPY_DIR=${HERE}/py FLASH_MODE=dio $*
