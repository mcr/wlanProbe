...
esp32ToolchainURL="https://dl.espressif.com/dl/xtensa-esp32-elf-linux64-1.22.0-80-g6c4433a-5.2.0.tar.gz"
...
if [ ! -f "micropythondev/${esp32ToolchainFile}" ]; then
    /usr/bin/curl "${esp32ToolchainURL}" > "micropythondev/${esp32ToolchainFile}"
fi
